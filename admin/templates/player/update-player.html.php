<h1 class="h1-admin text-center">Modifier un joueur</h1>
...
<form method="POST" action="">
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input class="form-control" type="text" name="nom" id="nom" value="<?php echo $player->getNom(); ?>">
            </div>
            <div class="form-group col-md-6">
                <label for="prenom">Prénom</label>
                <input class="form-control" type="text" name="prenom" id="prenom" value="<?php echo $player->getPrenom(); ?>">
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="ville">Ville</label>
                <input class="form-control" type="text" name="ville" id="ville" value="<?php echo $player->getVille(); ?>" required>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="numero">Numéro</label>
                <input class="form-control" type="number" name="numero" id="numero" value="<?php echo $player->getNumero(); ?>" required>
            </div>
            <div class="form-group col-md-6">
                ...
                <select class="custom-select" name="position" id="position" required>
                    ...
                    <?php foreach ($positions as $value): ?>
                        <option <?php if($player->getPosition() === $value->getId()): ?> selected <?php endif; ?> value="<?= $value->getId(); ?>"><?= $value->getLibelle(); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="custom-select" name="team" id="team" required>
                    ...
                    <?php foreach ($teams as $value): ?>
                        <option <?php if($player->getTeam() === $value->getId()): ?> selected <?php endif; ?> value="<?= $value->getId(); ?>"><?= $value->getNom(); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <div class="form-group col-md-6">
                ...
                <select class="custom-select" name="nationality" id="nationality" required>
                    ...
                    <?php foreach ($nationalities as $value): ?>
                        <option <?php if($player->getNationality() === $value->getId()): ?> selected <?php endif; ?> value="<?= $value->getId(); ?>"><?= $value->getLibelle(); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
